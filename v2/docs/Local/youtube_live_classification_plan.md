...
#### 1. YouTubeAPIPlugin._classify_video()（v2/plugins/youtube_api_plugin.py）
...
#### 2. YouTubeLivePlugin._classify_live()（v2/plugins/youtube_live_plugin.py）
...
- **DB スキーマ**: `v2/database.py` の `insert_video()` メソッド
