...
StreamNotify on Bluesky v2 のバージョン管理は、**3層の階層構造**で実装されています。
...
# 戻り値例: "v2.1.0 (2025-12-17) [development]"
```
...
#     "formatted": "v2.1.0 (2025-12-17) [development]"
# }
```
...
```
StreamNotify on Bluesky v2.1.0 (2025-12-17) [development]
```
...
| ステータス | 説明 | 出力例 |
|-----------|------|-------|
| `development` | 開発中 | `v2.1.0 (2025-12-17) [development]` |
| `alpha` | アルファ版 | `v2.1.0 (2025-12-17) [alpha]` |
| `beta` | ベータ版 | `v2.1.0 (2025-12-17) [beta]` |
| `stable` | 安定版 | `v2.1.0 (2025-12-17)` |
...
```bash
# Git タグ作成
git tag -a v2.2.0 -m "v2.2.0 release"
...
- [ARCHITECTURE_v2.md](ARCHITECTURE_v2.md) - アーキテクチャ全体
- [PLUGIN_MANAGER_INTEGRATION_v2.md](PLUGIN_MANAGER_INTEGRATION_v2.md) - プラグインシステム
...
**A:** 各プラグインは独立して開発・更新されるため、異なるバージョンを持つことは正常です。これにより、特定のプラグインだけを更新・改善することが可能になります。
...
例えば、アプリケーション v2.1.0 には、logging_plugin v2.0.0 と bluesky_plugin v1.1.0 が含まれています。

### Q: バージョン更新時の命名規則は？

**A:** セマンティックバージョニング (Semantic Versioning) を採用：
- `v[MAJOR].[MINOR].[PATCH]`
- 例) `v2.1.0`、`1.1.0`、`0.3.0`

---

**最終更新**: 2025-12-17 (v2.1.0)
