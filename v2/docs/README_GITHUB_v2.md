...
- ライブ配信・アーカイブの判別は **✅ YouTube Live判定プラグインで対応完了（v2.3.0）**
...
| YouTube ライブ判定 | ❌ 未対応 | ✅ **実装完了** (v2.3.0) | - |
| YouTube Live 自動投稿 | ❌ 未対応 | ✅ **実装完了** (v2.3.0) | - |
...
詳細は [V2_COMPLETION_PLAN.md](References/V2_COMPLETION_PLAN.md) を参照してください。
