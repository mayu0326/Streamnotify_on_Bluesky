...
**ファイル**: `v2/plugins/bluesky_plugin.py`
...
**ファイル**: `v2/bluesky_template_manager.py`
...
| ファイル | 変更内容 | チェック |
|:--|:--|:--:|
| `v2/plugins/bluesky_plugin.py` | テンプレート統合メソッド追加（+100 行） | ✅ |
...
1. **GUI 統合** - gui_v2.py にテンプレート編集メニューを追加
   - "テンプレート編集" ボタンを追加
