...
Streamnotify on Bluesky の最初のバージョン。YouTube RSS 監視と Bluesky 投稿の基本機能を実装。
...
プラグインアーキテクチャを導入し、拡張性を大幅に向上。YouTube Live 基本対応。

#### v2.1.0 AssetManager と Bluesky 投稿の安定性向上（2025-12-17）

AssetManager を導入してテンプレート・画像管理を自動化。Bluesky 投稿の安定性を向上。
...
#### v3.2.0 フィルタプロファイル保存機能（2025-12-19）

GUI フィルタ設定のプロファイル保存機能を追加。複数プロファイルの保存・切り替えが可能に。
...
#### v3.3.0 一括投稿スケジュール機能（2025-12-19）
