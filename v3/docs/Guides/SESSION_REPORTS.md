...
| ファイル | メソッド | 行数 | 変更内容 |
|:--|:--|:--:|:--|
| `v3/plugins/bluesky_plugin.py` | `post_video()` | +35 | テンプレートレンダリング処理追加 |
| `v3/bluesky_core.py` | `post_video_minimal()` | +12 | `text_override` 優先処理追加 |
...
| ファイル | 行数 | 変更内容 |
|:--|:--:|:--|
| `v3/image_processor.py` | +150 | 画像リサイズ三段階戦略 |
| `v3/bluesky_plugin.py` | +80 | テンプレート統合、AspectRatio |
| `v3/bluesky_core.py` | +25 | `text_override` 優先処理 |
| `v3/gui_v3.py` | +40 | DRY RUN、固定設定値 |
| `v3/plugin_interface.py` | +15 | ドライラン対応 |
...
| 項目 | ステータス | 予定 |
|:--|:--:|:--|
| YouTube Live ライブ判定 | ⏳ 実験的 | v3.x 実装予定 |
| Twitch 連携 | ⏳ 設計段階 | v3+ 実装予定 |
| GUI テンプレートエディタ | ✅ 実装済み | - |
| リアルタイムプレビュー | ⏳ 検討中 | v3.x 実装予定 |
