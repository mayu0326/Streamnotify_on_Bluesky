...
| **YouTube 新着動画** | ✅ 実装済み | v3.0.0 | youtube_new_video テンプレート |
| **Niconico 新着動画** | ✅ 実装済み | v3.1.0 | nico_new_video テンプレート |
